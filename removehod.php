...
if(!empty($_POST['user'])){
$user = $_POST['user'];
$query = mysqli_query($dbc, " DELETE FROM hod WHERE user='".$user."'");
}}

 $sql = "Select name,dept,file from hod";
...
$f="<img src='/var/www/html/FILES/".$row['file']."'>";
		 ?>
		                   <tr>
